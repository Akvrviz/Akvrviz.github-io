...
//
        String s1 ="C:\\Users\\高维投影\\Desktop\\查重文件\\orig.txt";
        String s2 ="C:\\Users\\高维投影\\Desktop\\查重文件\\orig_0.8_del.txt";
        String s3 ="C:\\Users\\高维投影\\Desktop\\查重文件\\1.txt";
    ...
    public static double calculation(ArrayList<String>array1,ArrayList<String>array2){
        for(String s1 : array2){
            ...
            for(String s2 : array1){
                ...
                if(dx.sameQuantity<sameQuantity){
                    dx.total = s1.length() + s2.length() - sameQuantity;
                    dx.sameQuantity = sameQuantity;
                    dx.rate = dx.sameQuantity/dx.total;
                }
            }
        ...
        for(int i =0; i < d.size(); i++){
            rate = rate + d.get(i).rate * d.get(i).total/total;
        }
        return  rate;
